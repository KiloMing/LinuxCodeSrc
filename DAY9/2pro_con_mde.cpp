/*
This is a  2-producer-2-consumer example using pthreads.
This program demonstrates the use of pthreads to implement a classic producer-consumer problem with two producers and two consumers.
*/
#include <iostream>
#include <sys/stat.h>
#include <unistd.h>
...
bool full = false;  
// the shared buffer is only a single item
// the shared buffer item is represented by an integer
...
const int PRODUCE_COUNT = 2; // total number of producers
int producer_count = 10; //  Every precess will produce 10 items
...
int main(void)
{
    ...
    pthread_t prod_thread1, cons_thread1, prod_thread_2, cons_thread2;
    int prod_id_1 = 1;
    int prod_id_2 = 2;
    int cons_id_1 = 1; 
    int cons_id_2 = 2; 
